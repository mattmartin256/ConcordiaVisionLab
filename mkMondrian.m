% function masks = mkMondrian(sz_x,sz_y,n_masks,shape,selection)
% 
...
loop_nr = round(4*(sz_y/sz_x)/mean(sizes.^2)); % if area is filled 8 times, this is normally sufficient
